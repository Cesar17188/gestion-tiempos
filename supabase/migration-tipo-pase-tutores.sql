...
-- para categorizar al adulto responsable (Cliente Frecuente, Nuevo Cliente, Alianza / Grupos).
...
COMMENT ON COLUMN public.tutores.tipo_pase IS 'Tipo de pase: Cliente Frecuente, Nuevo Cliente, Alianza / Grupos';
