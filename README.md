...
- **Control de Sesiones Dinámico (Dashboard):** Gestión interactiva de las sesiones activas, permitiendo extender o reducir tiempos con recálculo automático de costos, y actualizar el adulto responsable en tiempo real sin recargar la página.
